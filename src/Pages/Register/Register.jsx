        ...
        <div className="w-full max-w-md mx-auto p-8  space-y-3 rounded-xl bg-gray-900 text-gray-100">
          ...
          <form noValidate="" action="" className="space-y-6">
            ...
            <div className="space-y-1 text-sm ">
              <label htmlFor="name" className="block font-bold lg:text-xl">
                Name
              </label>
              <input type="text" name="name" id="name" placeholder="Type Your Name" className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900  focus:border-violet-400  " required />
            </div>
            {/* email */}
            <div className="space-y-1 text-sm ">
              <label htmlFor="username" className="block font-bold lg:text-xl">
                Email
              </label>
            ...
            {/* photourl */}
            <div className="space-y-1 text-sm ">
              <label htmlFor="photo" className="block font-bold lg:text-xl">
                PhotoURL
              </label>
              <input type="url" name="photo" id="name" placeholder="Paste Your Image URL" className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900  focus:border-violet-400  " required />
            </div>
            <div className="space-y-1 text-sm ">
              <label htmlFor="password" className="block font-bold lg:text-xl">
                Password
              </label>
