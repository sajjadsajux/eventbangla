...
const Login = () => {
  ...
  return (
    <>
      <div className="container mx-auto  flex justify-center items-center px-2 md:px-0 ">
        <div className="w-full max-w-md mx-auto p-8   space-y-3 rounded-xl bg-gray-900 text-gray-100 my-10">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-1 text-sm lg:text-base relative">
            ...
            <button type="submit" className="block w-full p-3 text-center rounded-sm  bg-primary font-bold hover:bg-green-600 hover:cursor-pointer">
              Log In
            </button>
          </form>
          ...
          <div className="flex justify-center space-x-4">
            <button onClick={handleGoogleLogin} type="button" className="flex flex-row items-center justify-center w-full p-2 space-x-2 border rounded-md hover:bg-green-600 hover:cursor-pointer">
              <BsGoogle />
